...
### 3.2 NER 태그 표준 (TTA 15종)

한국정보기술협회(TTA)에서 정의한 한국어 NER 표준 카테고리:

| 태그 | 의미 | 예시 |
|------|------|------|
| **PS** | 인물 (Person) | 이재용, 윤석열, BTS |
| **OR** | 기관 (Organization) | 삼성전자, 카카오, 국회 |
| **LC** | 지역 (Location) | 서울, 강남구, 미국 |
| **DT** | 날짜 (Date) | 2024년 1월, 어제 |
| **TI** | 시간 (Time) | 오후 3시, 아침 |
...
| 개체 유형 | 가중치 | 이유 |
|-----------|--------|------|
| OR (기관) | 1.5 | 뉴스에서 기업/기관명 중요 |
| PS (인물) | 1.3 | 인물 관련 뉴스 중요 |
| LC (지역) | 1.0 | 기본 가중치 |
| AF (인공물) | 1.2 | 제품명 등 |
